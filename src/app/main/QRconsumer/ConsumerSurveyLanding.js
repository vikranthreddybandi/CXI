      ...
      <div className="container border-1 border-grey">
        ...
        <div className="min-h-128 bg-green-darkest px-12">
          <div className="flex p-16 items-center">
            <img
              src={"../assets/images/logos/brand_logo.png"}
              className="w-96 bg-white p-12 mr-20"
            />
            <Typography className="text-white text-20 font-800 leading-tight sm:text-24 capitalize ">
        ...
        <div className="px-28 py-20">
          <Typography className="text-green-darkest text-18 font-bold sm:text-22">
            About Survey
          </Typography>
          <Typography className="text-16 text-grey-darkest pt-6">
            Hello, we are three ungraduate students from the American University
            of Dubai and we would really appreciate it if you complete this
            survey with your honest opinion about Starbucks. Note that the
            survey will be strictly confidential, your identity will stay
            anonymous.The survey consists of 25 questions it will take you 5-7
            minutes. We would like to thank you in advance for participating on
            our survey.
          </Typography>
        </div>
        ...
        <div className="px-28 py-20">
          ...
          <Typography className="text-16 text-grey-darkest pt-6">
            This survey to help us better understand customers experience with
            Starbucks.
          </Typography>
        </div>
        <Divider className="border-grey" />
