...
function ChefsGridContent(props) {
    ...
    <div>
        <Grid container spacing={16}>
            ...
            <Grid item xs={12} sm={6} md={4}>
                <Card className={classNames(classes.card, "rounded-6 shadow-none border-1 border-grey-darker")}>
                    <div className={classes.details}>
                        ...
                        <CardContent className={classes.content}>
                            ...
                            <Typography>
                                {/* Card Heading */}
                                    <div className="text-black-dark gs-b leading-none w-full float-left text-18 py-16">
...
ChefsGridContent.propTypes = {
  classes: PropTypes.object.isRequired,
  theme: PropTypes.object.isRequired,
};

export default withStyles(styles, { withTheme: true })(ChefsGridContent);
